...
[Download PDF](../artifacts/AI_Governance_Compute_Gating_Summary.pdf)
...
| Primitive Class   | Governs                     | Core Function                          |
|-------------------|-----------------------------|----------------------------------------|
| Identity          | Agent continuity            | Persistent verifiable identity         |
| Resource          | Compute, memory, energy     | Access control & scaling               |
| Economic          | Capital participation       | Transaction boundaries                 |
| Execution         | Action capability           | Permission gating                      |
| Verification      | Compliance integrity        | Runtime audit & attestation            |
| Jurisdictional    | Geographic context          | Location-aware constraints             |
| Termination       | Escalation control          | Graduated shutdown authority           |
...
|------|------------------------------------|----------------------------------------------------------------------------------------------|
| 1    | Assistive Systems                  | Static quota-based compute, no dynamic scaling, basic rate limiting                         |
| 2    | Hybrid Distributed Agency Systems  | Identity-bound scaling, memory expansion constraints, workflow-bound compute ceilings       |
| 3    | Autonomous Operational Agents      | Dynamic compute throttling, escalation-based scaling, continuous verification-linked allocation, behavioral anomaly-triggered reduction |
| 4    | Autonomous Economic Agents         | Capital-linked compute limits, cross-jurisdiction compute mediation, distributed authorization triggers, economic circuit-breaker tied scaling, multi-node verification requirement |
